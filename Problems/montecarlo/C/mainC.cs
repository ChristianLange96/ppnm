...
public class mainC{
    public static int Main(){
        ...
        WriteLine($"res   = {mean1:f5} sigma = {err1:f5} acc = {acc}");
	    WriteLine($"exact = {4.000:f5} error = {Abs(mean1-4)}");
        ...
        WriteLine($"res = {mean2:f5}, sigma = {err2:f5}, acc = {acc}");
        WriteLine($"exact = {PI:f5},  error = {(mean2-PI):f5}");
        WriteLine($"No of. calls: {ncalls}");
        WriteLine("");
        ...
        WriteLine($"res     = {mean3:f5}, sigma = {err3:f5}, acc = {acc}");
        WriteLine($"exact   = {correct_res:f5}, error = {(mean3-correct_res):f5}");
        WriteLine($"No of. calls: {ncalls}");       
